...
function foo_cb($context) {
    ...
    var_dump($context);
    return algoweb_span_create('doctrine');
}
...
algoweb_span_callback('no_span', 'no_span_cb');
algoweb_span_callback('throwex', 'throwex_cb');
algoweb_span_callback('closured', function ($context) {
    echo "Inside Closure\n";
    var_dump($context);
});
algoweb_span_callback('Foo::bar', function ($context) {
    echo "With Object\n";
    var_dump($context);
