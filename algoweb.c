...
#if PHP_VERSION_ID < 70000
void (*algoweb_original_error_cb)(int type, const char *error_filename, const uint error_lineno, const char *format, va_list args);
void algoweb_error_cb(int type, const char *error_filename, const uint error_lineno, const char *format, va_list args);
#else
static void algoweb_throw_exception_hook(zval *exception TSRMLS_DC);
#endif
...
static void hp_begin(long algoweb_flags TSRMLS_DC);
...
/* {{{ arginfo */
ZEND_BEGIN_ARG_INFO_EX(arginfo_algoweb_enable, 0, 0, 0)
  ZEND_ARG_INFO(0, flags)
  ZEND_ARG_INFO(0, options)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_algoweb_disable, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_algoweb_transaction_name, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_algoweb_prepend_overwritten, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_algoweb_fatal_backtrace, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_algoweb_last_detected_exception, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_algoweb_last_fatal_error, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_algoweb_sql_minify, 0, 0, 0)
    ZEND_ARG_INFO(0, sql)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_algoweb_span_create, 0, 0, 0)
    ZEND_ARG_INFO(0, category)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO(arginfo_algoweb_get_spans, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_algoweb_span_timer_start, 0, 0, 0)
    ZEND_ARG_INFO(0, span)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_algoweb_span_timer_stop, 0, 0, 0)
    ZEND_ARG_INFO(0, span)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_algoweb_span_annotate, 0, 0, 0)
    ZEND_ARG_INFO(0, span)
    ZEND_ARG_INFO(0, annotations)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_algoweb_span_watch, 0, 0, 0)
    ZEND_ARG_INFO(0, name)
    ZEND_ARG_INFO(0, category)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_algoweb_span_callback, 0, 0, 0)
    ZEND_ARG_INFO(0, name)
 ...
 * *********************
 */
/* List of functions implemented/exposed by Algoweb */
zend_function_entry algoweb_functions[] = {
    PHP_FE(algoweb_enable, arginfo_algoweb_enable)
    PHP_FE(algoweb_disable, arginfo_algoweb_disable)
    PHP_FE(algoweb_transaction_name, arginfo_algoweb_transaction_name)
    PHP_FE(algoweb_prepend_overwritten, arginfo_algoweb_prepend_overwritten)
    PHP_FE(algoweb_fatal_backtrace, arginfo_algoweb_fatal_backtrace)
    PHP_FE(algoweb_last_detected_exception, arginfo_algoweb_last_detected_exception)
    PHP_FE(algoweb_last_fatal_error, arginfo_algoweb_last_fatal_error)
    PHP_FE(algoweb_sql_minify, arginfo_algoweb_sql_minify)
    PHP_FE(algoweb_span_create, arginfo_algoweb_span_create)
    PHP_FE(algoweb_get_spans, arginfo_algoweb_get_spans)
    PHP_FE(algoweb_span_timer_start, arginfo_algoweb_span_timer_start)
    PHP_FE(algoweb_span_timer_stop, arginfo_algoweb_span_timer_stop)
    PHP_FE(algoweb_span_annotate, arginfo_algoweb_span_annotate)
    PHP_FE(algoweb_span_watch, arginfo_algoweb_span_watch)
    PHP_FE(algoweb_span_callback, arginfo_algoweb_span_callback)
    {NULL, NULL, NULL}
};

ZEND_DECLARE_MODULE_GLOBALS(hp)

/* Callback functions for the Algoweb extension */
zend_module_entry algoweb_module_entry = {
    STANDARD_MODULE_HEADER,
    "algoweb",                        /* Name of the extension */
    algoweb_functions,                /* List of functions exposed */
    PHP_MINIT(algoweb),               /* Module init callback */
    PHP_MSHUTDOWN(algoweb),           /* Module shutdown callback */
    PHP_RINIT(algoweb),               /* Request init callback */
    PHP_RSHUTDOWN(algoweb),           /* Request shutdown callback */
    PHP_MINFO(algoweb),               /* Module info callback */
    ALGOWEB_VERSION,
 ...
 */
PHP_INI_ENTRY("algoweb.connection", "unix:///var/run/algoweb/algowebd.sock", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.udp_connection", "127.0.0.1:8135", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.auto_start", "1", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.api_key", "", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.framework", "", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.sample_rate", "30", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.auto_prepend_library", "1", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.collect", "tracing", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.monitor", "basic", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.monitor_cli", "0", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.distributed_tracing_hosts", "127.0.0.1", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.log_level", "0", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.max_spans", "1500", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.timeout", "10000", PHP_INI_ALL, NULL)
PHP_INI_ENTRY("algoweb.service", "", PHP_INI_ALL, NULL)

PHP_INI_END()

/* Init module */
ZEND_GET_MODULE(algoweb)

PHP_GINIT_FUNCTION(hp)
{
    hp_globals->enabled = 0;
    hp_globals->ever_enabled = 0;
    hp_globals->algoweb_flags = 0;
...
#if PHP_VERSION_ID < 70000
    algoweb_original_error_cb = zend_error_cb;
    zend_error_cb = algoweb_error_cb;
#else
    zend_throw_exception_hook = algoweb_throw_exception_hook;
#endif
...
#if PHP_VERSION_ID < 70000
    zend_error_cb = algoweb_original_error_cb;
#else
...
long tw_trace_callback_mongo_cursor_next(char *symbol, zend_execute_data *data TSRMLS_DC)
{
    ...
    zval *__rv;
    queryRunProperty = _zend_read_property(cursor_ce, object, "_algowebQueryRun", sizeof("_algowebQueryRun")-1, 1, __rv);

    if (queryRunProperty != NULL && Z_TYPE_P(queryRunProperty) != IS_NULL) {
        return idx;
    }

    zend_update_property_bool(cursor_ce, object, "_algowebQueryRun", sizeof("_algowebQueryRun") - 1, 1 TSRMLS_CC);
...
long tw_trace_callback_oxid_tx(char *symbol, zend_execute_data *data TSRMLS_DC)
{
    ...
    if ((TWG(algoweb_flags) & ALGOWEB_FLAGS_NO_SPANS) > 0) {
        return -1;
    }
 ...
 *
 * Check if Algoweb.php exists in extension_dir and load it
 * in request init. This makes class \Algoweb\Profiler available
 * for usage.
 */
PHP_RINIT_FUNCTION(algoweb)
{
    ...
    if (INI_INT("algoweb.auto_prepend_library") == 0) {
        return SUCCESS;
    }

    extension_dir  = INI_STR("extension_dir");
    profiler_file_len = strlen(extension_dir) + strlen("Algoweb.php") + 2;
    profiler_file = emalloc(profiler_file_len);
    snprintf(profiler_file, profiler_file_len, "%s/%s", extension_dir, "Algoweb.php");
...
/**
 * Module info callback. Returns the Algoweb version.
 */
PHP_MINFO_FUNCTION(algoweb)
{
    ...
    php_info_print_table_header(2, "algoweb", ALGOWEB_VERSION);

    php_info_print_table_row(2, "Connection (algoweb.connection)", INI_STR("algoweb.connection"));
    php_info_print_table_row(2, "UDP Connection (algoweb.udp_connection)", INI_STR("algoweb.udp_connection"));
    php_info_print_table_row(2, "Default API Key (algoweb.api_key)", INI_STR("algoweb.api_key"));
    php_info_print_table_row(2, "Default Sample-Rate (algoweb.sample_rate)", INI_STR("algoweb.sample_rate"));
    php_info_print_table_row(2, "Framework Detection (algoweb.framework)", INI_STR("algoweb.framework"));
    php_info_print_table_row(2, "Service Name (algoweb.service)", INI_STR("algoweb.service"));
    php_info_print_table_row(2, "Automatically Start (algoweb.auto_start)", INI_INT("algoweb.auto_start") ? "Yes": "No");
    php_info_print_table_row(2, "Algoweb Collect Mode (algoweb.collect)", INI_STR("algoweb.collect"));
    php_info_print_table_row(2, "Algoweb Monitoring Mode (algoweb.monitor)", INI_STR("algoweb.monitor"));
    php_info_print_table_row(2, "CLI Monitoring enabled (algoweb.monitor_cli)", INI_STR("algoweb.monitor_cli"));
    php_info_print_table_row(2, "Timeout for talk to Daemon (algoweb.timeout)", INI_STR("algoweb.timeout"));
    php_info_print_table_row(2, "Allowed Distributed Tracing Hosts (algoweb.distributed_tracing_hosts)", INI_STR("algoweb.distributed_tracing_hosts"));
    php_info_print_table_row(2, "Load PHP Library (algoweb.auto_prepend_library)", INI_INT("algoweb.auto_prepend_library") ? "Yes": "No");
    ...
    if (VCWD_ACCESS(profiler_file, F_OK) == 0) {
        php_info_print_table_row(2, "Algoweb.php found", "Yes");
    } else {
        php_info_print_table_row(2, "Algoweb.php found", "No");
    }
...
static void hp_register_constants(INIT_FUNC_ARGS)
{
    REGISTER_LONG_CONSTANT("ALGOWEB_FLAGS_CPU", ALGOWEB_FLAGS_CPU, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALGOWEB_FLAGS_MEMORY", ALGOWEB_FLAGS_MEMORY, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALGOWEB_FLAGS_NO_BUILTINS", ALGOWEB_FLAGS_NO_BUILTINS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALGOWEB_FLAGS_NO_USERLAND", ALGOWEB_FLAGS_NO_USERLAND, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALGOWEB_FLAGS_NO_COMPILE", ALGOWEB_FLAGS_NO_COMPILE, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALGOWEB_FLAGS_NO_SPANS", ALGOWEB_FLAGS_NO_SPANS, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("ALGOWEB_FLAGS_NO_HIERACHICAL", ALGOWEB_FLAGS_NO_HIERACHICAL, CONST_CS | CONST_PERSISTENT);
}
...
static inline hp_function_map *hp_function_map_create(char **names)
{
    ...
    memset(map->filter, 0, ALGOWEB_FILTERED_FUNCTION_SIZE);
...
void hp_init_profiler_state(TSRMLS_D)
{
    ...
    TWG(max_spans) = INI_INT("algoweb.max_spans");
...
/**
 * ALGOWEB_MODE_HIERARCHICAL's begin function callback
 *
 * @author kannan
 */
void hp_mode_hier_beginfn_cb(hp_entry_t **entries, hp_entry_t *current, zend_execute_data *data TSRMLS_DC)
{
    ...
    if ((TWG(algoweb_flags) & ALGOWEB_FLAGS_NO_SPANS) == 0 && data != NULL) {
#if PHP_VERSION_ID < 70000
    ...
    if ((TWG(algoweb_flags) & ALGOWEB_FLAGS_NO_HIERACHICAL) == 0) {
        ...
        /* Get CPU usage */
        if (TWG(algoweb_flags) & ALGOWEB_FLAGS_CPU) {
            current->cpu_start = cpu_timer();
        }

        /* Get memory usage */
        if (TWG(algoweb_flags) & ALGOWEB_FLAGS_MEMORY) {
...
/**
 * **********************************
 * ALGOWEB END FUNCTION CALLBACKS
 * **********************************
 */

/**
 * ALGOWEB_MODE_HIERARCHICAL's end function callback
 *
 * @author kannan
 */
void hp_mode_hier_endfn_cb(hp_entry_t **entries, zend_execute_data *data TSRMLS_DC)
{
    ...
    if ((TWG(algoweb_flags) & ALGOWEB_FLAGS_NO_SPANS) == 0 && top->span_id >= 0) {
...
/**
 * Algoweb enable replaced the zend_execute function with this
...
ZEND_DLEXPORT void hp_execute_ex (zend_execute_data *execute_data TSRMLS_DC) {
    ...
    if ((TWG(algoweb_flags) & ALGOWEB_FLAGS_NO_USERLAND) > 0) {
#if PHP_VERSION_ID < 50500
        _zend_execute(ops TSRMLS_CC);
#else
        _zend_execute_ex(execute_data TSRMLS_CC);
...
ZEND_DLEXPORT void hp_execute_internal(zend_execute_data *execute_data,
    ...
    if (!TWG(enabled) || (TWG(algoweb_flags) & ALGOWEB_FLAGS_NO_BUILTINS) > 0) {
#if PHP_MAJOR_VERSION == 7
...
ZEND_DLEXPORT zend_op_array* hp_compile_file(zend_file_handle *file_handle, int type TSRMLS_DC)
{
    if (!TWG(enabled) || (TWG(algoweb_flags) & ALGOWEB_FLAGS_NO_COMPILE) > 0) {
...
/**
 * **************************
 * MAIN ALGOWEB CALLBACKS
 * **************************
 */

/**
 * This function gets called once when Algoweb gets enabled.
...
static void hp_begin(long algoweb_flags TSRMLS_DC)
{
    if (!TWG(enabled)) {
        ...
        TWG(enabled) = 1;
        TWG(algoweb_flags) = (uint32)algoweb_flags;
...
/**
 * Called from algoweb_disable(). Removes all the proxies setup by
...
/**
 * *****************************
 * ALGOWEB ZVAL UTILITY FUNCTIONS
 * *****************************
 */
...
static inline void hp_array_del(char **name_array)
{
    if (name_array != NULL) {
        int i = 0;
        for(; name_array[i] != NULL && i < ALGOWEB_MAX_FILTERED_FUNCTIONS; i++) {
            efree(name_array[i]);
        }
        efree(name_array);
    }
...
int tw_gc_collect_cycles(void)
{
    ...
    if (!TWG(enabled) || (TWG(algoweb_flags) & ALGOWEB_FLAGS_NO_SPANS) > 0) {
...
void algoweb_error_cb(int type, const char *error_filename, const uint error_lineno, const char *format, va_list args)
{
    ...
    algoweb_original_error_cb(type, error_filename, error_lineno, format, args);
}
#else
static void algoweb_throw_exception_hook(zval *exception TSRMLS_DC)
{
...
static void algoweb_add_callback_watch(zend_fcall_info fci, zend_fcall_info_cache fcic, char *func, int func_len TSRMLS_DC)
{
...
PHP_FUNCTION(algoweb_span_callback)
{
    ...
    if (zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC, "sf", &func, &func_len, &fci, &fcic) == FAILURE) {
        zend_error(E_ERROR, "algoweb_span_callback() expects a string as a first and a callback as a second argument");
        return;
    }
    ...
    algoweb_add_callback_watch(fci, fcic, func, func_len TSRMLS_CC);
}
...
/**
 * Start Algoweb profiling in hierarchical mode.
 *
...
PHP_FUNCTION(algoweb_enable)
{
    ...
    if (zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC,
                "|lz", &algoweb_flags, &optional_array) == FAILURE) {
        return;
    }

    hp_parse_options_from_arg(optional_array TSRMLS_CC);

    hp_begin(algoweb_flags TSRMLS_CC);
}

/**
 * Stops Algoweb from profiling  and returns the profile info.
 *
 * @param  void
 * @return array  hash-array of Algoweb's profile info
 * @author cjiang
 */
